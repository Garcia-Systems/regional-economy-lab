...
from regional_economy.reporting import comparison, full_report
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("command", help="scenario name, or 'compare'")
    parser.add_argument("scenarios", nargs="*", help="two scenario names for compare")
    return parser
